...
export default function ROIReportPage() {
  ...
  const exportToCSV = () => {
    ...
    link.setAttribute('download', `roi_transactions_${new Date().toISOString().split('T')[0]}.csv`);
  ...
  const exportToExcel = () => {
    ...
    const url = URL.createObjectURL(blob);
    link.setAttribute('href', url);
    link.setAttribute('download', `roi_transactions_${new Date().toISOString().split('T')[0]}.xls`);
    link.style.visibility = 'hidden';
    document.body.appendChild(link);
    link.click();
    document.body.removeChild(link);
          ...
          <div className="bg-white rounded-lg shadow overflow-hidden">
            <div className="px-6 py-4 border-b border-gray-200">
              <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-4">
                <h3 className="text-lg font-semibold text-black">ROI Transactions</h3>
                ...
                <div className="flex gap-4 flex-wrap items-center">
                  ...
                  <div className="flex gap-2 items-center">
                    ...
                    <input
                      ...
                      className="px-3 py-2 border text-black  border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-500"
                    />
