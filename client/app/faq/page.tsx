...
export default function FAQPage() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer:
        "You can contact our support team through the Support section in your dashboard. Create a support ticket, and our team will respond to you as soon as possible.",
    },
  ];
      ...
      <div className="container mx-auto px-4 py-16">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-lg text-gray-600 mb-12 text-center">
            Find answers to common questions about Big Bull Energies
          </p>
