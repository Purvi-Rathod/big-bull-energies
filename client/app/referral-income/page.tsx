        ...
        <div className="max-w-4xl mx-auto space-y-12">
          ...
          <div className="p-8 bg-yellow-500/5 backdrop-blur-md rounded-2xl border border-yellow-500/20">
            ...
            <p className="text-white/80 text-lg leading-relaxed mb-6">
              Referral income is a one-time bonus you receive when someone you directly referred to CNEOX makes 
              their first investment. This instant reward recognizes your role in expanding the CNEOX community 
            ...
            <div className="space-y-6 mt-8">
              <div className="p-6 bg-yellow-500/5 rounded-xl">
                ...
                <p className="text-white/70 mb-4">
                  ...
                  friends, family, or anyone interested in joining CNEOX.
                </p>
                <div className="bg-black/30 p-4 rounded-lg">
                  <p className="text-yellow-400 font-mono text-sm">
                    Your Referral Link: https://cneox.com/signup?ref=CNEOX-XXXXXX
                  </p>
                </div>
              </div>
          ...
          <div className="p-8 bg-gradient-to-br from-purple-500/20 via-pink-500/20 to-cyan-500/20 backdrop-blur-md rounded-2xl border border-white/20">
            ...
            <ul className="space-y-4 text-white/80 text-lg">
              ...
              <li className="flex items-start">
                ...
                <span><strong className="text-white">Educate Your Referrals:</strong> Help your referrals understand the platform so they're more likely to invest. The better they understand CNEOX, the more confident they'll be.</span>
              </li>
              <li className="flex items-start">
                <span className="text-yellow-400 mr-3 text-xl">•</span>
          ...
          <div className="text-center p-8 bg-gradient-to-br from-purple-500/20 via-pink-500/20 to-cyan-500/20 backdrop-blur-md rounded-2xl border border-white/20">
            ...
            <p className="text-white/80 mb-6 text-lg">
              Join CNEOX and get your unique referral link to start building your network
            </p>
