...
export default function CneoLoader({ 
  size = 'md', 
  text = 'CNEOX',
  fullScreen = false,
  className = ''
  ...
  const uniqueId = useMemo(() => `cneo-loader-${Math.random().toString(36).substr(2, 9)}`, []);

  return (
    <>
      <div className={`${containerClass} ${className} cneo-loader-container`}>
