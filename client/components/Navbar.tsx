    ...
    items: [
      {
        ...
        icon: Flame,
        description: "Flexible, reliable generation",
      },
      {
        label: "Solar",
        href: "/energy-technologies/solar",
        icon: Sun,
        description: "Utility-scale clean power",
      },
      {
        label: "Land-based Wind",
        href: "/energy-technologies/wind",
        icon: Wind,
        description: "Renewable wind generation",
      },
      {
        label: "Storage",
        href: "/energy-technologies/storage",
        icon: Battery,
        description: "Grid-balancing batteries",
      },
      {
        label: "Transmission",
        href: "/energy-technologies/transmission",
        icon: Network,
        description: "Connecting power to markets",
      },
      {
        label: "Geothermal",
        href: "/energy-technologies/geothermal",
        icon: Mountain,
        description: "Baseload heat-powered energy",
      },
    ],
  },
  {
