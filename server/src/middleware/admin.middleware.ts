 ...
 * Also allows CROWN-000000 or CNEOX-000000 user to access admin routes with user token
  ...
  try {
    ...
    try {
      ...
      try {
        ...
        // Check if this user is CROWN-000000 or CNEOX-000000
        const user = await User.findById(decoded.sub);
        if (user && (user.userId === "CROWN-000000" || user.userId === "CNEOX-000000")) {
          // Allow CROWN-000000 or CNEOX-000000 user to access admin routes
