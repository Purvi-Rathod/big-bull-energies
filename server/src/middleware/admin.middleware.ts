 ...
 * Also allows BIGBULL-000000 or CNEOX-000000 user to access admin routes with user token
  ...
  try {
    ...
    try {
      ...
      try {
        ...
        // Check if this user is BIGBULL-000000 or CNEOX-000000
        const user = await User.findById(decoded.sub);
        if (user && (user.userId === "BIGBULL-000000" || user.userId === "CROWN-000000" || user.userId === "CNEOX-000000")) {
          // Allow BIGBULL-000000 or CNEOX-000000 user to access admin routes
